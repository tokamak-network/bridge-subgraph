...
export class FailedRelayedFastMessage extends ethereum.Event {
  get params(): FailedRelayedFastMessage__Params {
    return new FailedRelayedFastMessage__Params(this);
  }
}

export class FailedRelayedFastMessage__Params {
  _event: FailedRelayedFastMessage;

  constructor(event: FailedRelayedFastMessage) {
    this._event = event;
  }
...
export class RelayedFastMessage extends ethereum.Event {
  get params(): RelayedFastMessage__Params {
    return new RelayedFastMessage__Params(this);
  }
}

export class RelayedFastMessage__Params {
  _event: RelayedFastMessage;

  constructor(event: RelayedFastMessage) {
    this._event = event;
  }
...
export class BatchRelayMessagesCall extends ethereum.Call {
  get inputs(): BatchRelayMessagesCall__Inputs {
    return new BatchRelayMessagesCall__Inputs(this);
  }

  get outputs(): BatchRelayMessagesCall__Outputs {
    return new BatchRelayMessagesCall__Outputs(this);
  }
}

export class BatchRelayMessagesCall__Inputs {
  _call: BatchRelayMessagesCall;

  constructor(call: BatchRelayMessagesCall) {
    this._call = call;
  }

  get _messages(): Array<BatchRelayMessagesCall_messagesStruct> {
    return this._call.inputValues[0].value.toTupleArray<
      BatchRelayMessagesCall_messagesStruct
    >();
  }
}

export class BatchRelayMessagesCall__Outputs {
  _call: BatchRelayMessagesCall;
...
export class BatchRelayMessagesCall_messagesStruct extends ethereum.Tuple {
  get target(): Address {
  ...
  get proof(): BatchRelayMessagesCall_messagesProofStruct {
    return changetype<BatchRelayMessagesCall_messagesProofStruct>(
      this[4].toTuple()
    );
  }
}

export class BatchRelayMessagesCall_messagesProofStruct extends ethereum.Tuple {
  get stateRoot(): Bytes {
    return this[0].toBytes();
  }

  get stateRootBatchHeader(): BatchRelayMessagesCall_messagesProofStateRootBatchHeaderStruct {
    return changetype<
      BatchRelayMessagesCall_messagesProofStateRootBatchHeaderStruct
    >(this[1].toTuple());
  }

  get stateRootProof(): BatchRelayMessagesCall_messagesProofStateRootProofStruct {
    return changetype<BatchRelayMessagesCall_messagesProofStateRootProofStruct>(
      this[2].toTuple()
    );
  }
...
export class BatchRelayMessagesCall_messagesProofStateRootBatchHeaderStruct extends ethereum.Tuple {
...
export class BatchRelayMessagesCall_messagesProofStateRootProofStruct extends ethereum.Tuple {
  get index(): BigInt {
    return this[0].toBigInt();
  }
